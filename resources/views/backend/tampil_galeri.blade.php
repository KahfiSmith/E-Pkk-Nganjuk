              ...
              <form action="{{ route('galeri.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                  <label for="gambar" class="form-label">Gambar</label><br>
                    ...
                    <!-- <img src="{{ asset('frontend2/assets/gallery2/'.$data->gambar) }}" alt="{{ $data->judul }}" class="rounded" width="200"> -->
                    
                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                          <img src="{{ asset('frontend2/assets/gallery2/'.$data->gambar) }}" class="d-block w-100" alt="...">
                        </div>
