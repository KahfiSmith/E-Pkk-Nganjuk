        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('pendidikan.update', $data->id_pokja2_bidang1) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="id_pokja2_bidang1" id="id_pokja2_bidang1" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_pokja2_bidang1 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warga_buta" class="form-label">Warga Buta</label>
                    <input type="text" name="warga_buta" id="warga_buta" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warga_buta }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="kel_belajarA" class="form-label">Kelompok Belajar A</label>
                    <input type="text" name="kel_belajarA" id="kel_belajarA" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kel_belajarA }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warga_belajarA" class="form-label">Warga Belajar A</label>
                    <input type="text" name="warga_belajarA" id="warga_belajarA" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu terintegrasi')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warga_belajarA }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="kel_belajarB" class="form-label">Kelompok Belajar B</label>
                    <input type="text" name="kel_belajarB" id="kel_belajarB" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kel_belajarB }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warga_belajarB" class="form-label">Warga Belajar B</label>
                    <input type="text" name="warga_belajarB" id="warga_belajarB" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warga_belajarB }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="kel_belajarC" class="form-label">Kelompok Belajar C</label>
                    <input type="text" name="kel_belajarC" id="kel_belajarC" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kel_belajarC }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warga_belajarC" class="form-label">Warga Belajar C</label>
                    <input type="text" name="warga_belajarC" id="warga_belajarC" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warga_belajarC }}"/>
                </div>

                
                <div class="form-outline mb-4 mt-3">
                    <label for="kel_belajarKF" class="form-label">Kelompok Belajar KF</label>
                    <input type="text" name="kel_belajarKF" id="kel_belajarKF" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kel_belajarKF }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warga_belajarKF" class="form-label">Warga Belajar KF</label>
                    <input type="text" name="warga_belajarKF" id="warga_belajarKF" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warga_belajarKF }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->paud }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="taman_bacaan" class="form-label">Taman Bacaan</label>
                    <input type="text" name="taman_bacaan" id="taman_bacaan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->taman_bacaan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_klp" class="form-label">Jumlah Klp</label>
                    <input type="text" name="jumlah_klp" id="jumlah_klp" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_klp }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_ibu_peserta" class="form-label">Jumlah Ibu Peserta</label>
                    <input type="text" name="jumlah_ibu_peserta" id="jumlah_ibu_peserta" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_ibu_peserta }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_ape" class="form-label">Jumlah Ape</label>
                    <input type="text" name="jumlah_ape" id="jumlah_ape" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_ape }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_kel_simulasi" class="form-label">Jumlah Kelompok Simulasi</label>
                    <input type="text" name="jumlah_kel_simulasi" id="jumlah_kel_simulasi" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kel_simulasi }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="KF" class="form-label">KF</label>
                    <input type="text" name="KF" id="KF" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->KF }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="paud_tutor" class="form-label">Paud Tutor</label>
                    <input type="text" name="paud_tutor" id="paud_tutor" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->paud_tutor }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->BKB }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->koperasi }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="ketrampilan" class="form-label">Ketrampilan</label>
                    <input type="text" name="ketrampilan" id="ketrampilan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->ketrampilan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="LP3PKK" class="form-label">LP3PKK</label>
                    <input type="text" name="LP3PKK" id="LP3PKK" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->LP3PKK }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="TP3PKK" class="form-label">TP3PKK</label>
                    <input type="text" name="TP3PKK" id="TP3PKK" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->TP3PKK }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="damas_pkk" class="form-label">Damas PKK</label>
                    <input type="text" name="damas_pkk" id="damas_pkk" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->damas_pkk }}"/>
                </div>
