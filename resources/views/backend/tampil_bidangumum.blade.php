        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('bidangumum.update', $data->id_laporan_umum ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->KK }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jiwa_laki" class="form-label">Jiwa Laki</label>
                    <input type="text" name="jiwa_laki" id="jiwa_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jiwa_laki }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jiwa_perempuan" class="form-label">Jiwa Perempuan</label>
                    <input type="text" name="jiwa_perempuan" id="jiwa_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jiwa_perempuan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="anggota_laki" class="form-label">Anggota Laki</label>
                    <input type="text" name="anggota_laki" id="anggota_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->anggota_laki }}"/>
                </div>
                
                <div class="form-outline mb-4 mt-3">
                    <label for="anggota_perempuan" class="form-label">Anggota Perempuan</label>
                    <input type="text" name="anggota_perempuan" id="anggota_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->anggota_perempuan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="umum_laki" class="form-label">Umum Laki</label>
                    <input type="text" name="umum_laki" id="umum_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah umum')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->umum_laki }}"/>
                </div>
                
                <div class="form-outline mb-4 mt-3">
                    <label for="umum_perempuan" class="form-label">umum Perempuan</label>
                    <input type="text" name="umum_perempuan" id="umum_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah umum')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->umum_perempuan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="khusus_laki" class="form-label">Khusus Laki</label>
                    <input type="text" name="khusus_laki" id="khusus_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="khusus_perempuan" id="khusus_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->khusus_perempuan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="honorer_laki" class="form-label">Honorer Laki</label>
                    <input type="text" name="honorer_laki" id="honorer_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="honorer_perempuan" id="honorer_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->honorer_perempuan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="bantuan_laki" class="form-label">Bantuan Laki</label>
                    <input type="text" name="bantuan_laki" id="bantuan_laki" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="bantuan_perempuan" id="bantuan_perempuan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah ')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->bantuan_perempuan }}"/>
                </div>
