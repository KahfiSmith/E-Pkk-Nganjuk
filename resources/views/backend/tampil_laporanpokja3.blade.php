        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('laporanpokja3.update', $data->id_kader_pokja3) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="id_kader_pokja3" id="id_kader_pokja3" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan kesehat')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_kader_pokja3 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="tata_laksana_rumah" id="tata_laksana_rumah" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->tata_laksana_rumah }}"/>
                </div>
