        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('penghayatan.update', $data->id_pokja1_bidang1) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    <label for="id_pokja1_bidang1" class="form-label">ID Laporan Penghayatan Dan Pengamalan Pancasila</label>
                    <input type="text" name="id_pokja1_bidang1" id="id_pokja1_bidang1" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan kesehat')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_pokja1_bidang1 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kel_simulasi1 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_anggota1" class="form-label">Jumlah Anggota 1</label>
                    <input type="text" name="jumlah_anggota1" id="jumlah_anggota1" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_anggota1 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kel_simulasi2 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_anggota2" class="form-label">Jumlah Anggota 2</label>
                    <input type="text" name="jumlah_anggota2" id="jumlah_anggota2" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_anggota2 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kel_simulasi3 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_anggota3" class="form-label">Jumlah Anggota 3</label>
                    <input type="text" name="jumlah_anggota3" id="jumlah_anggota3" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_anggota3 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kel_simulasi4 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_anggota4" class="form-label">Jumlah Anggota 4</label>
                    <input type="text" name="jumlah_anggota4" id="jumlah_anggota4" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_anggota4 }}"/>
                </div>
