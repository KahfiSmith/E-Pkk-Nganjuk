        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('kesehatan.update', $data->id_laporan_sehat) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    <label for="id_laporan_sehat" class="form-label">ID Laporan Kesehatan</label>
                    <input type="text" name="id_laporan_sehat" id="id_laporan_sehat" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan kesehat')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_laporan_sehat }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="kategori_laporan" class="form-label">Kategori Laporan</label>
                    <input type="text" name="kategori_laporan" id="kategori_laporan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kategori_laporan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_posyandu" class="form-label">Jumlah Posyandu</label>
                    <input type="text" name="jumlah_posyandu" id="jumlah_posyandu" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_posyandu }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_posyandu_iterasi }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_anggota }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="jumlah_kartu_gratis" class="form-label">Jumlah Kartu Gratis</label>
                    <input type="text" name="jumlah_kartu_gratis" id="jumlah_kartu_gratis" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah kartu gratis')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->jumlah_kartu_gratis }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="gambar_upload" class="form-label">Gambar</label>
                    <input type="text" name="gambaru" id="gambaru" disabled class="form-control"
                    value="{{ $data->gambar_upload }}"/>
                    @if ($data->gambar_upload)
                    <img src="{{ asset('frontend2/assets/Bidang_kesehatan/'.$data->gambar_upload) }}" alt="{{ $data->judul }}" class="rounded mt-3" width="200" height="200">
                    @endif
                </div>
