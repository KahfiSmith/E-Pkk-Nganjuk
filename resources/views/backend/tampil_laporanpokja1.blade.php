        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('laporanpokja1.update', $data->id_kader_pokja1) }}" method="POST" enctype="multipart/form-data">
