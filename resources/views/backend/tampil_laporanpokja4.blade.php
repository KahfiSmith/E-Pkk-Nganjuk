            ...
            <div class="card-body mt-4">
              <form action="{{ route('laporanpokja4.update', $data->id_kader_pokja4) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="id_kader_pokja4" id="id_kader_pokja4" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan kesehat')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_kader_pokja4 }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->posyandu }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->gizi }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="kesling" class="form-label">Kesling</label>
                    <input type="text" name="kesling" id="kesling" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->kesling }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="penyuluhan_narkoba" class="form-label">Penyuluhan Narkoba</label>
                    <input type="text" name="penyuluhan_narkoba" id="penyuluhan_narkoba" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->penyuluhan_narkoba }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="PHBS" class="form-label">PHBS</label>
                    <input type="text" name="PHBS" id="PHBS" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->PHBS }}"/>
                </div>
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->KB }}"/>
                </div>
