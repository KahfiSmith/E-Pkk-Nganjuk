        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('pangan.update', $data->id_pokja3_bidang1) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="id_pokja3_bidang1" id="id_pokja3_bidang1" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_pokja3_bidang1 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="beras" class="form-label">Beras</label>
                    <input type="text" name="beras" id="beras" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->beras }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="non_beras" class="form-label">Non Beras</label>
                    <input type="text" name="non_beras" id="non_beras" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->non_beras }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="peternakan" class="form-label">Peternakan</label>
                    <input type="text" name="peternakan" id="peternakan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu terintegrasi')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->peternakan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="perikanan" class="form-label">Perikanan</label>
                    <input type="text" name="perikanan" id="perikanan" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->perikanan }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="warung_hidup" class="form-label">Warung Hidup</label>
                    <input type="text" name="warung_hidup" id="warung_hidup" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->warung_hidup }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="lumbung_hidup" class="form-label">Lumbung Hidup</label>
                    <input type="text" name="lumbung_hidup" id="lumbung_hidup" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->lumbung_hidup }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="toga" class="form-label">Toga</label>
                    <input type="text" name="toga" id="toga" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->toga }}"/>
                </div>
                
                <div class="form-outline mb-4 mt-3">
                    <label for="tanaman_keras" class="form-label">Tanaman Keras</label>
                    <input type="text" name="tanaman_keras" id="tanaman_keras" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->tanaman_keras }}"/>
                </div>
