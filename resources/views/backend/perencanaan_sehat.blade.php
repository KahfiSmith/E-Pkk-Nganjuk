              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $p_sehat->tanggal }}</td>
                    <td>
                         <a href="{{ route('perencanaan_sehat.edit', $p_sehat->id_p_sehat) }}" class="btn btn-sm btn-tambah">Review</a>

                        <form action="{{ route('perencanaan_sehat.destroy', $p_sehat->id_p_sehat)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
