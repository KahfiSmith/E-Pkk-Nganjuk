            ...
            <div class="card-body">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row">{{ $no++ }}</th>
                    <td><img src="{{ asset('frontend2/assets/Bidang_LingkunganHidup/'.$pangan->gambar_upload) }}" class="rounded img" width="200" height="200">
                    </td>
                    ...
                    <td>{{ $pangan->status }}</td>
                    <td>{{ $pangan->tanggal }}</td>
                    <td>
                         <a href="{{ route('kelestarian_lingkungan_hidup.edit', $pangan->id_kelpangan) }}" class="btn btn-sm btn-tambah">Review</a>

                        <form action="{{ route('kelestarian_lingkungan_hidup.destroy', $pangan->id_kelpangan)}}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
