        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('perumahan.update', $data->id_pokja3_bidang3) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirmSubmission()">
                ...
                <div class="form-outline mb-4 mt-3">
                    <label for="id_pokja3_bidang3" class="form-label">ID Laporan Program Perumahan Dan Tata Laksana Rumah Tangga</label>
                    <input type="text" name="id_pokja3_bidang3" id="id_pokja3_bidang3" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi id laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->id_pokja3_bidang3 }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="layak_huni" class="form-label">Layak Huni</label>
                    <input type="text" name="layak_huni" id="layak_huni" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->layak_huni }}"/>
                </div>

                <div class="form-outline mb-4 mt-3">
                    <label for="tidak_layak" class="form-label">Tidak Layak</label>
                    <input type="text" name="tidak_layak" id="tidak_layak" class="form-control"
                    required readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')" 
                    oninput="this.setCustomValidity('')" 
                    placeholder="Masukkan Judul" value="{{ $data->tidak_layak }}"/>
                </div>
