      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            ...
            </br>الْحَمْدُ ِللهِ رَبِّ الْعَالَمِيْنَ وَالصَّلاَةُ وَالسَّلاَمُ عَلَى أَشْرَفِ اْلأَنْبِيَاءِ وَالْمُرْسَلِيْنَ وَعَلَى اَلِهِ وَصَحْبِهِ أَجْمَعِيْنَ أَمَّا بَعْدُ</br>

            </br>"Puji dan syukur marilah kita panjatkan kehadirat ilahi Rabbi, atas karunia-Nya kita bisa sama-sama berkumpul dalam rangka thalabulilmi, mencari ilmu dan pahala bersama. Alhamdulillah kita dapat bertatap muka dalam sebuah forum yang mulia ini dalam kadaan aman fi amanillah, sehat wal afiat. Mudah-mudahan setiap derap langkah bisa membuahkan pahala bagi kita semua, bisa menjadi penghapus dosa dan pengangkat derajat di hadapan Allah SWT. Tak lupa, shalawat serta salam senantiasa tercurah kepada junjungan kita Nabi Agung Muhammad Saw. Kepada keluarganya, sahabatnya, para tabi’in, tabiut tabiahum, kepada kita semua, serta kepada seluruh umatnya hingga akhir zaman yang menjadikan sebagai uswatun hasanah, suri tauladan yang baik. Semoga kita senantiasa dalam syafa'atnya Yaumul Akhir nanti, Amin Allohuma Amin..."</br>

            </br>DENGAN senang hati dan tangan terbuka kami menyampaikan salam yang hangat bagi Anda untuk mengenal TP PKK Kabupaten Nganjuk</br>
            ...
            </br>Situs ini diharapkan akan memberikan informasi yang cukup mengenai Kinerja Tim Penggerak Kabupaten Nganjuk secara umum tentang Rangkaian Kegiatan, Rencana Kerja, dan Program Kerja TP PKK Kabupaten Nganjuk.</br>

            </br>Dalam rangka penertiban Administrasi bagi seluruh anggota Tim Penggerak PKK se-kabupaten Nganjuk, Maka dengan ini Website PKK diluncurkan.
            Kebersamaan, dan Kegotong Royongan dalam membangun dan menebarkan mafaat sebesar-besarnya bagi Masyarakat adalah tujuan dalam derap langkah kami.</br>
                        
            </br>Kabupaten Nganjuk adalah "Surga" bagi kami. Keindahan alamnya, Khasanah Budayanya, Masyarakatnya, Pemerintahan yang Amanah dan InshaAllah memegang komitmen dalam melayani penuh Masyarakatnya, adalah tujuan kami bersama.
            Kerajinan Daerahnya, serta Pariwisata yang sedang dengan serius kami upayakan agar apat mengoptimalkan potensi baik yang ada. Peningkatan kualitas Pendidikan Anak Usia Dini di berbagai sektor pendidikan menjadi salah satu fokus kerja prioritas kami. TP PKK Kabupaten Nganjuk mengusung SEPEDA KEREN (Sekolah perempuan dan Anak Kelompok Rentan) sebagai wujud keseriusan kami dalam upaya pengentasan kemiskinan dan ke-tidakberdayaan bagi kelompok marginal di Kabupaten Nganjuk.</br>

            </br>Bismillahirohmanirohim,
            Dengan kemudahan mengakses informasi tentang PKK Kabupaten Nganjuk melalui situs ini, pada kesempatan ini saya mengajak masyarakat Kabupaten Trenggalek untuk bersama-sama memajukan PKK dalam rangka mewujudkan kesejahteraan masyarakat Kabupaten Nganjuk secara menyeluruh. No One Left Behind.</br>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="a{{ asset ('frontend/ssets/img/portfolio/portfolio-7.jpg')}}" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Card 1</h4>
              <p>Card</p>
